    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50">
      <div className="max-w-[1200px] mx-auto px-6 py-4">
        ...
        <div className="md:hidden relative">
          ...
          <div className={`relative mx-2 mb-4 p-3 rounded-2xl border shadow-2xl backdrop-blur-xl transition-all duration-300 ${
            scrolled 
            ...
            <div className="relative flex justify-center items-center space-x-6 mb-4">
              <Link 
                href="/" 
              ...
              >
                <FolderOpen size={20} className="drop-shadow-sm group-hover:scale-110 transition-transform duration-200" />
              ...
              >
                <BookOpen size={20} className="drop-shadow-sm group-hover:scale-110 transition-transform duration-200" />
              ...
              <div className="flex flex-col items-center space-y-1.5">
                ...
                >
                  ...
                  <div className={`absolute top-0.5 w-5 h-5 bg-white dark:bg-gray-800 rounded-full shadow-md transition-all duration-300 flex items-center justify-center border border-cyan-400/50 ${
                    theme === 'dark' ? 'translate-x-5' : 'translate-x-0.5'
                  }`}>
                    <Sun className={`h-3 w-3 text-amber-500 transition-all duration-300 ${
                      theme === 'dark' ? 'scale-0 rotate-180' : 'scale-100 rotate-0'
                    }`} />
                    <Moon className={`absolute h-3 w-3 text-cyan-400 transition-all duration-300 ${
                      theme === 'dark' ? 'scale-100 rotate-0' : 'scale-0 -rotate-180'
                    }`} />
                  </div>
                </div>
                <span className="text-xs font-bold tracking-tight text-gray-700 dark:text-gray-200">Theme</span>
              </div>
            </div>
            
            {/* Compact footer */}
            <div className="relative border-t border-cyan-400/20 pt-3">
        ...
        <div className={`hidden md:flex justify-between items-center rounded-xl shadow-2xl px-6 py-3 relative border backdrop-blur-xl transition-all duration-300 ${
          scrolled 
            ? 'bg-white/95 dark:bg-black/95 border-cyan-400/20' 
            : 'bg-white/95 dark:bg-black/95 border-cyan-400/10'
        }`}>
