...
<h2 class="text-2xl font-semibold text-primary my-4">The Frustration That Sparked the Idea </h2>
...
<h2 class="text-2xl font-semibold text-primary my-4">So, What Is DeepFind.Me?</h2>

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="/blog-images/dfme.png" className="m-4" alt="DeepFind.Me home page" width="800" height="450"/>
</div>
...
<h2 class="text-2xl font-semibold text-primary my-4">How You Can Come Up With Project Ideas</h2>
...
<h3 class="text-xl font-semibold text-primary my-4">1. Start by Solving Your Own Problems </h3>
...
<h3 class="text-xl font-semibold text-primary my-4">2. Mix What You Know with What You’re Interested In</h3>
...
<h3 class="text-xl font-semibold text-primary my-4">3. Don’t Worry About Trends</h3>
...
<h3 class="text-xl font-semibold text-primary my-4">4. Launch Fast, Improve Later </h3>
