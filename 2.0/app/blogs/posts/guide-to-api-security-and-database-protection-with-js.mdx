...
<h2 class="text-2xl font-semibold text-primary my-4" id="what-are-apis-and-databases">What Are APIs and Databases? </h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="types-of-api-security-threats">Types of API Security Threats </h2>

Think of threats as ways a thief might break into your house. Here's what to watch out for:

<h3 class="text-xl font-semibold text-primary my-4" id="injection-attacks">1. Injection Attacks </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="broken-authentication">2. Broken Authentication</h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="sensitive-data-exposure">3. Sensitive Data Exposure </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="security-misconfigurations">4. Security Misconfigurations</h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="denial-of-service-attacks">5. Denial of Service (DoS) Attacks </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="sneaky-advanced-threats">6. Sneaky Advanced Threats </h3>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="api-security-best-practices">API Security Best Practices </h2>
...
<h3 class="text-xl font-semibold text-primary my-4" id="check-ids-with-authentication-and-authorization">1. Check IDs with Authentication and Authorization </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="set-rules-with-role-based-access-control">2. Set Rules with Role-Based Access Control (RBAC) </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="clean-up-user-input">3. Clean Up User Input </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="stop-overcrowding-with-rate-limiting">4. Stop Overcrowding with Rate Limiting </h3>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="database-protection-strategies">Database Protection Strategies </h2>
...
<h3 class="text-xl font-semibold text-primary my-4" id="common-weak-spots">1. Common Weak Spots </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="safe-queries-with-parameters">2. Safe Queries with Parameters </h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="scramble-sensitive-data">3. Scramble Sensitive Data</h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="row-level-security">4. Row-Level Security (RLS)</h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="lock-the-safe">5. Lock the Safe </h3>
