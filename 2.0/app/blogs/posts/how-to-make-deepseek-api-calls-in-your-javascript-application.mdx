...
<h2 class="text-2xl font-semibold text-primary my-4" id="setting-up-api-access">Setting Up API Access </h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="making-api-calls-deepseek-vs-openai">Making API Calls: DeepSeek vs. OpenAI </h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="key-differences">Key Differences </h2> 
...
<h2 class="text-2xl font-semibold text-primary my-4" id="which-one-to-use">Which One to Use? </h2> 
