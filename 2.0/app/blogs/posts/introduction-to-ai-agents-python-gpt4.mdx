...
<h2 class="text-2xl font-semibold text-primary my-4" id="what-are-ai-agents">What are AI Agents?</h2>
...
<h2 class="text-xl font-semibold text-primary my-4" id="how-they-work">How They Work?</h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="types-of-ai-agents">Types of AI Agents</h2>
...
<h3 class="text-xl font-semibold text-primary my-4" id="real-world-examples-types">Real-World Examples</h3>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="why-use-ai-agents">Why Use AI Agents for Everyday Tasks?</h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="create-ai-agent">Create a Simple AI Agent: A Weather-Based Clothing Suggester</h2>

<h3 class="text-xl font-semibold text-primary my-4" id="design-the-agent">Design the Agent</h3>
...
<h3 class="text-xl font-semibold text-primary my-4" id="code-it-in-python">Code It in Python </h3>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="real-world-examples-demo">Real-World Examples</h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="test-and-tweak">Test and Tweak</h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="taking-it-further">Taking It Further</h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="why-this-matters">Why This Matters</h2>
