...
<h2 class="text-2xl font-semibold text-primary my-4" id="installing-the-openai-api-helper-npm-package">Installing the `openai-api-helper` npm Package </h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="usage">Usage </h2>
...
<h2 class="text-2xl font-semibold text-primary my-4" id="example-output">Example Output </h2>
